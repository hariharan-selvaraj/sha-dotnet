    ...
    <div class="custom_container">
        ...
        <div class="div_container" style="width: 100%;">
            <div class="grid_container">
                ...
                <div class="grid_head">
                    <asp:GridView ID="CompanyGridView" CssClass="grid_view" runat="server" OnRowDataBound="SetDataRowId" OnSelectedIndexChanged="CompanyGridView_SelectedIndexChanged" AutoGenerateColumns="false" AllowPaging="true">
                        <Columns>
